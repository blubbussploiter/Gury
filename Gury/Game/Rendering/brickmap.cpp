...
RBX::BrickColor RBX::BrickColor::BrickMap::brickColorFromName(std::string name)
{
	...
	for (it = colors.begin(); it != colors.end(); it++)
	{
		...
		{
			BrickColor color;
			color.number.name = n.name;
			color.number.number = n.number;
...
RBX::BrickColor RBX::BrickColor::BrickMap::brickColorFromNumber(int number)
{
	std::map<Number, Color3>::iterator it;
...
{
	return brickColorFromNumber(number).color;
}

Color3 RBX::BrickColor::BrickMap::fromName(std::string name)
{
	return brickColorFromName(name).color;
}
